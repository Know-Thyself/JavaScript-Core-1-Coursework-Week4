...
*/
function isAccessibleByTransportMode(arrayOfTransports, transportStr) {
	return arrayOfTransports.includes(transportStr);
}
...
function journeyPlanner(locations, transportMode) {
	const accessibleByTheTransportMode = locations.filter(
		(location) => isAccessibleByTransportMode(location, transportMode)
	);
  return accessibleByTheTransportMode.map(getLocationName);
}
